...
CREATE INDEX IF NOT EXISTS idx_viewing_schedules_property_id ON viewing_schedules(property_id);
CREATE INDEX IF NOT EXISTS idx_viewing_schedules_preferred_date ON viewing_schedules(preferred_date);
CREATE INDEX IF NOT EXISTS idx_viewing_schedules_created_at ON viewing_schedules(created_at DESC);
...
DROP POLICY IF EXISTS "Anyone can submit viewing schedules" ON viewing_schedules;
DROP POLICY IF EXISTS "Users can view their own contact inquiries" ON contact_inquiries;
DROP POLICY IF EXISTS "Users can view their own viewing schedules" ON viewing_schedules;
